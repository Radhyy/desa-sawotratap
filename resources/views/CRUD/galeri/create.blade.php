...
@section('page-description', 'Tambahkan foto baru ke galeri desa')
...
<div class="row g-4">
            ...
            <div class="form-card">
                ...
                <div class="upload-tabs">
                    ...
                    <div class="upload-tab" onclick="switchTab('url', this)">
                        <i class="bi bi-link-45deg me-1"></i> Masukkan URL
                    </div>
                </div>
                ...
                <div id="tab-url" style="display:none;">
                    ...
                    <div class="form-hint">Masukkan URL gambar yang sudah tersedia di internet</div>
                </div>
    ...
    <div class="col-lg-4">
        <div class="info-card">
            <div class="info-card-header"><i class="bi bi-lightbulb-fill text-warning"></i> Panduan Upload</div>
            <div class="info-card-body">
                <div class="info-row"><i class="bi bi-image"></i><span><strong>Ukuran foto</strong> disarankan landscape (4:3 atau 16:9), minimal 800x600px.</span></div>
                <div class="info-row"><i class="bi bi-file-earmark-image"></i><span>Format yang didukung: <strong>JPG, PNG, GIF, WEBP</strong>. Batas ukuran 4MB per foto.</span></div>
                <div class="info-row"><i class="bi bi-link-45deg"></i><span>Bisa juga masukkan <strong>URL gambar</strong> langsung dari internet.</span></div>
                <div class="info-row"><i class="bi bi-tags"></i><span>Pilih <strong>kategori</strong> yang sesuai agar foto mudah disaring di halaman galeri.</span></div>
            </div>
        </div>
    </div>
</div>
