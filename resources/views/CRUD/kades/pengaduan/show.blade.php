...
@section('title', 'Detail Pengaduan - Kepala Desa')
@section('page-title', 'Detail Pengaduan')
@section('page-description', 'Tinjau dan tindaklanjuti laporan pengaduan warga')
...
<div class="row">
    <div class="col-lg-8">
        <div class="admin-card mb-4">
            <div class="d-flex justify-content-between align-items-start mb-4 border-bottom pb-3">
                ...
                @endphp
                <span class="badge bg-{{ $statusColor }} fs-6 px-3 py-2">{{ $pengaduan->status }}</span>
            </div>
    ...
    <div class="col-lg-4">
        <div class="admin-card">
            <h6 class="fw-bold mb-3">Tindak Lanjut Kepala Desa</h6>

            <form action="{{ route('kades.pengaduan.update-status', $pengaduan) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="mb-3">
                    <label class="form-label fw-bold small">Catatan / Arahan Kepala Desa (Opsional)</label>
                    <textarea name="catatan_kades" class="form-control" rows="3"
                        placeholder="Tulis arahan, persetujuan, atau penolakan...">{{ $pengaduan->catatan_kades }}</textarea>
                </div>
                ...
                <div class="alert alert-info small mb-0">
                    ...
                    Pengaduan telah Anda setujui dan saat ini sedang <strong>Diproses</strong> oleh tim.
                </div>
                ...
                <div class="alert alert-danger small mb-0">
                    ...
                    Pengaduan ini telah Anda tolak.
                </div>
                @endif
            </form>
            ...
            <a href="{{ route('kades.pengaduan.index') }}" class="btn btn-light w-100">
