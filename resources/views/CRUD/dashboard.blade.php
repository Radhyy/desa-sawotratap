...
<div class="row mb-4 g-3">
    ...
    <div class="col-md-3">
        <div class="stat-card sc-green">
            <i class="bi bi-megaphone stat-bg-icon stat-accent"></i>
            <div class="stat-label">Total Pengumuman</div>
            <div class="stat-value">{{ $stats['total_announcements'] }}</div>
            <div class="stat-desc"><span class="stat-accent fw-semibold">Semua</span> pengumuman desa</div>
        </div>
    </div>
    <!-- Stat Card 2 -->
    <div class="col-md-3">
        <div class="stat-card sc-teal">
            <i class="bi bi-check2-circle stat-bg-icon stat-accent"></i>
            <div class="stat-label">Pengumuman Aktif</div>
            <div class="stat-value">{{ $stats['active_announcements'] }}</div>
            <div class="stat-desc"><span class="stat-accent fw-semibold">Sedang</span> ditampilkan</div>
        </div>
    </div>
    <!-- Stat Card 3 -->
    <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="stat-card sc-amber">
            <i class="bi bi-shield-lock stat-bg-icon stat-accent"></i>
            <div class="stat-label">Administrator</div>
            <div class="stat-value">{{ $stats['admin_users'] }}</div>
            <div class="stat-desc"><span class="stat-accent fw-semibold">Akses</span> penuh sistem</div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-4">
        <div class="admin-card h-100">
            <div class="card-header-custom">
                ...
                <a href="{{ route('admin.announcements.index') }}" class="text-decoration-none" style="font-size: 0.85rem; font-weight: 600; color: var(--sidebar-active);">Lihat Semua</a>
            </div>
...
<div class="row">
    ...
    <div class="col-lg-6 mb-4 mb-lg-0">
        <div class="admin-card h-100">
            <div class="card-header-custom">
                <h5><i class="bi bi-envelope-paper-fill me-2 text-success"></i>Pengajuan Surat Terbaru</h5>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" style="font-size: 0.9rem;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="fw-bold text-dark">{{ $surat->user->name ?? 'Warga' }}</div>
                            ...
                            <td>
                                ...
                                @else
                                    <span class="badge bg-danger border border-danger">Ditolak</span>
                                @endif
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="3" class="text-center py-4 text-muted">Belum ada pengajuan surat</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
