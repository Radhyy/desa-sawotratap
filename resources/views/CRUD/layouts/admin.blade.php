...
<head>
    ...
    <style>
        :root {
            ...
            --sidebar-bg: #152c0a; /* Sleek solid dark green */
            --sidebar-hover: rgba(255, 255, 255, 0.08);
            --sidebar-active: #2d5016; /* Primary green */
            --text-muted: #9ca3af;
        }
        ...
        /* The "Showing X to Y of Z results" text */
...
<body>
    ...
    <div class="admin-sidebar" id="sidebar">
        ...
        <div class="sidebar-header">
            <a href="{{ route('home') }}" class="sidebar-brand">
                ...
                <div class="sidebar-brand-text">
                    <span class="brand-sub">Pemerintah Desa</span>
        ...
        <div class="sidebar-menu">
            ...
            <a href="{{ route('admin.announcements.index') }}" class="menu-item {{ request()->routeIs('admin.announcements.*') ? 'active' : '' }}" title="Pengumuman">
            ...
            <a href="#" class="menu-item" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" title="Logout">
        ...
        <div class="admin-topbar">
            <div class="topbar-left">
                ...
                <div class="topbar-title">
                    ...
                    <p>@yield('page-description', 'Ringkasan sistem dan aktivitas')</p>
                </div>
            </div>
