...
@section('page-description', 'Daftar semua laporan pengaduan dari warga')

@section('content')
<div class="admin-card">
    <div class="card-header-custom">
        <h5><i class="bi bi-chat-left-text-fill me-2"></i>Daftar Pengaduan Warga</h5>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.pengaduan.show', $aduan) }}" class="btn btn-sm btn-info text-white">
