...
@section('title', 'Perizinan Warga - Kepala Desa')
@section('page-title', 'Perizinan Warga')
@section('page-description', 'Daftar pengajuan izin warga yang membutuhkan persetujuan Kepala Desa')

@section('content')
<div class="admin-card">
    <div class="card-header-custom">
        <h5><i class="bi bi-file-earmark-check-fill me-2"></i>Daftar Perizinan</h5>
        ...
        <table class="table table-hover align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('kades.perizinan.show', $izin) }}" class="btn btn-sm btn-info text-white">
                            <i class="bi bi-eye"></i>
                        </a>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="8" class="text-center py-5">
                        ...
                        Belum ada perizinan yang menunggu persetujuan Anda.
                    </td>
                </tr>
                @endforelse
            </tbody>
